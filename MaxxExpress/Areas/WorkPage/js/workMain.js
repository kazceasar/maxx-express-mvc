...
jQuery(document).ready(function ($) {
	...
	function forceLogout() {
	    $.ajax({
	        ...
	        success: function (data) {
	            window.location.href = "../Work/logout";
	        }
	    });   
	}
	...
	$('#btn-delete-note').on('click', function (event) {
	    ...
	    $.ajax({
	        method: "PUT",
	        url: '../Work/EditNote?NoteID=' + note_ID + '&EditType=' + editType + '',
	        dataType: "JSON",
	...
	$('#open-load-row').on('click', '.loadnumber_cl', function (event) {
	    ...
	    $("#loadsdtl").load('../Work/GetLoadDetail?LoadNbr=' + load_num + '&LoadState=open');	   
	...
	$('#closed-load-row').on('click', '.closedloadnumber_cl', function (event) {
	    $("#loadsdtl").html('<div class="loading-message"></div>').css('min-height', '100px');
	    var load_num = $(this).text();
	    $("#loadsdtl").load('../Work/GetLoadDetail?LoadNbr=' + load_num + '&LoadState=closed');
	    $('#loadDetailModal').modal('show');
	...
	$('.editthisLoad_btn').on('click', function (event) {
	    ...
	    $("#openloadsEdit").load('../Work/GetLoadEditDetail?LoadNbr=' + load_num);
	...
	$('.edit-load-btn').on('click', function (event) {
	    $('#edit-load-success').addClass('hide');
	    $("#openloadsEditList").load('../Work/GetLoadChangeList?ChangeAction=edit');
	    $('#loadEditListModal').modal('show');
	...
	$('.add-load-btn_driver').on('click', function (event) {
	    ...
	    $("#openloadsAdd").load('../Work/GetAddLoad', function () { createTempLoadNbr() });
	...
	$('.add-fuel-btn_driver').on('click', function (event) {
	    ...
	    $("#fuelPurchaseAdd").load('../Work/GetAddFuel', function () { null });
	...
	$('.delete-fuel-btn_driver').on('click', function (event) {
	    ...
	    $("#openfuelDeleteList").load('../Work/GetFuelPurchasesList', function () { null });
	...
	$('.delete-load-btn_driver').on('click', function (event) {
	    resetAction();
	    reloadIndex();	
	    $("#openloadsEditList").load('../Work/GetLoadChangeList?ChangeAction=delete');
	...
	$('.delete-load-btn').on('click', function (event) {
	    resetAction();
	    reloadIndex();
	    $("#openloadsDeleteList").load('../Work/GetLoadChangeList?ChangeAction=delete');
	    $('#loadDeleteListModal').modal('show');
	...
	$('.update-status-btn').on('click', function (event) {
	    ...
	    $("#openloadsStatusList").load('../Work/GetLoadChangeList?ChangeAction=status');
	...
	$('#btn-delete-load').on('click', function (event) {
	 var load_num = '';
	    ...
	    $.ajax({
	        method: "DELETE",
	        url: '../Work/DeleteLoad?LoadNbr=' + load_num,
	        dataType: "JSON",
	        contentType: "application/json; charset=utf-8",
	        success: function (response) {
	            if (response.success) {
	...
	$('#btn-paid-fuel').on('click', function (event) {
	    ...
	    $.ajax({
	        method: "PUT",
	        url: '../Work/MarkFuelPaid?id=' + fuelID,
	        dataType: "JSON",
	        contentType: "application/json; charset=utf-8",
	        success: function (response) {
	            if (response.success) {
	...
	$('#btn-Update-Load').on('click', function (event) {
	   // $('#Loading_Modal').modal('show');
	    ...
	    $.ajax({
	        method: "PUT",
	        url: '../Work/EditLoad?LoadNbr=' + load_num,
	        dataType: "JSON",
	        contentType: "application/json; charset=utf-8",
	        data: dataset,
	        success: function (response) {
	...
	$('#reset-status-btn').on('click', function (event) {
	    ...
	    $.ajax({
	        method: "GET",
	        url: '../Work/resetLoad?pLoadNbr=' + load_num + '&pResetType=' + resetType + '',
	        dataType: "JSON",
	        contentType: "application/json; charset=utf-8",
	        success: function (response) {
	            if (response.success) {
	...
	$('#btn-pickup-load').on('click', function (event) {
	    ...
	    $.ajax({
	        method: "PUT",
	        url: '../Work/UpdateLoadStatus?LoadNbr=' + load_num + '&newStatus=' + load_status + '&bypassEmailNotification=' + bypass_email + '',
	        dataType: "JSON",
	        contentType: "application/json; charset=utf-8",
	        success: function (response) {
	            if (response.success) {
	...
	$('#btn-deliver-load').on('click', function (event) {
	    ...
	    $.ajax({
	        method: "PUT",
	        url: '../Work/UpdateLoadStatus?LoadNbr=' + load_num + '&newStatus=' + load_status + '&BOLattached=' + load_bol + '&BOLurl=' + load_bol_url + '&bypassEmailNotification=' + bypass_email + '',
	        dataType: "JSON",
	        contentType: "application/json; charset=utf-8",
	        success: function (response) {
	            if (response.success) {
	...
	$('#btn-paid-load').on('click', function (event) {
	    ...
	    $.ajax({
	        method: "PUT",
            url: '../Work/UpdateLoadStatus?LoadNbr=' + load_num + '&newStatus=' + load_status + '&loadPaidAmount=' + load_final_amount.trim() + '&detentionAmount=' + detention_amount_final_amount.trim() + '',
	        dataType: "JSON",
	        contentType: "application/json; charset=utf-8",
	        success: function (response) {
	            if (response.success) {
	...
	$('.payroll-adj-btn').on('click', function (event) {
	    $("#openpayrollAdjustment").load('../Work/GetPayrollAdjustmentDetail');
	...
	$('#btn-Update-Adj').on('click', function (event) {
	    ...
	    $.ajax({
	        method: "PUT",
	        url: '../Work/EditPayrollAdjustments',
	        dataType: "JSON",
	        contentType: "application/json; charset=utf-8",
	        data: dataset,
	        success: function (response) {
	...
	$(".closedloads-dateview-dd > .cs-options").on('click', function (event) {
	    ...
	    $('#closed-load-row').load('../Work/GetClosedLoadSummaryIndex?pViewDate=' + selected_val);
	...
	$(".payroll-dateview-dd > .cs-options").on('click', function (event) {
	    ...
	    $("#payroll-row-data").load('../Work/GetPayrollSummaryIndex?pViewDate=' + selected_val + '&pEmployee=' + employeeInput);
	});
	...
	$(".payroll-personview-dd > .cs-options").on('click', function (event) {
	    ...
	    $("#payroll-row-data").load('../Work/GetPayrollSummaryIndex?pViewDate=' + dateInput + '&pEmployee=' + selected_val);
	});
	...
	$(".expenses-dateview-dd > .cs-options").on('click', function (event) {
	    ...
	    $("#expenses-row-data").load('../Work/GetExpenseSummary?pViewDate=' + selected_val + '&pExpenseType=' + typeInput);
	    $("#expenses-totals-header").load('../Work/GetExpenseTotalHeader?pViewDate=' + selected_val + '&pExpenseType=' + typeInput);
	...
	$(".expenses-typeview-dd > .cs-options").on('click', function (event) {
	    ...
	    $("#expenses-row-data").load('../Work/GetExpenseSummary?pViewDate=' + dateInput + '&pExpenseType=' + selected_val);
	    $("#expenses-totals-header").load('../Work/GetExpenseTotalHeader?pViewDate=' + dateInput + '&pExpenseType=' + selected_val);
	...
	$(".fuel-dateview-dd > .cs-options").on('click', function (event) {
	    ...
	    $("#fuel-row-data").load('../Work/GetFuelSummary?pViewDate=' + selected_val + '&pEmployee=' + employeeInput);
	    $("#fuel-totals-header").load('../Work/GetFuelTotalHeader?pViewDate=' + selected_val + '&pEmployee=' + employeeInput);
	});
	...
	$(".fuel-personview-dd > .cs-options").on('click', function (event) {
	    ...
	    $("#fuel-row-data").load('../Work/GetFuelSummary?pViewDate=' + dateInput + '&pEmployee=' + selected_val);
	    $("#fuel-totals-header").load('../Work/GetFuelTotalHeader?pViewDate=' + dateInput + '&pEmployee=' + selected_val);
	});
	...
	$(".financials-dateview-dd > .cs-options").on('click', function (event) {
	    ...
	    $("#load-revenue-row-data").load('../Work/GetFinancialLoadGross?pViewDate=' + selected_val);
	    $("#deposit-revenue-row-data").load('../Work/GetFinancialDeposits?pViewDate=' + selected_val);
	    $("#fuel-revenue-row-data").load('../Work/GetFinancialFuel?pViewDate=' + selected_val);
	    $("#payroll-revenue-row-data").load('../Work/GetFinancialPayroll?pViewDate=' + selected_val);
	    $("#expenses-reoccurring-row-data").load('../Work/GetFinancialExpensesRO?pViewDate=' + selected_val);
	    $("#expenses-revenue-row-data").load('../Work/GetFinancialExpenses?pViewDate=' + selected_val);
	...
	$(".production-dateview-dd > .cs-options").on('click', function (event) {
	    ...
	    $("#production-detail-row-data").load('../Work/GetProductionDetailWeekly?pViewDate=' + selected_val);
	    $("#production-summary-row-data").load('../Work/GetProductionWeekly?pViewDate=' + selected_val);
	});
	...
	$('.production-value').on('click', function (event) {
	    ...
	    $("#production-popover-row-data").load('../Work/GetProductionModal?pDataSource=' + datasource + '&pPeriod=' + period);
	...
	$('.production-value-driver').on('click', function (event) {
	    ...
	    $("#production-popover-row-data").load('../Work/GetProductionModal?pDataSource=' + datasource + '&pPeriod=' + period + '&pEntity=' + entity);
	...
	function financialTotalsUpdate(newdate) {
	    ...
	    $.ajax({
	        method: "GET",
	        url: '../Work/reloadFinancials?pViewDate=' + newdate,
	        dataType: "JSON",
	        contentType: "application/json; charset=utf-8",
	        success: function (response) {
	            if (response.success) {
	        ...
	        error: function (response) {  //Working Error 

	            $("#NET-PNL-Value").load('../Work/reloadFinancials_NET');
	            $("#Load-Revenue-Value").load('../Work/reloadFinancials_Revenue');
	            $("#Fuel-Total-Value").load('../Work/reloadFinancials_Fuel');
	            $("#Payroll-Total-Value").load('../Work/reloadFinancials_Payroll');
	            $("#Expenses-Total-Value").load('../Work/reloadFinancials_Expenses');
	            $('#financialLoading_Modal').modal("hide");
	...
	$(document).on("click", ".add-expense-purpose", function (e) {
	    ...
	    $("#expense-purpose-row").load('../Work/GetExpenseDetail?exID=' + expense_ID);
	    ...
	    $.ajax({
	        ...
	        success: function (response) {
	            if (response.success) {
	                ...
	                $("#expenses-row-data").load('../Work/GetExpenseSummary?pViewDate=' + dateInput + '&pEmployee=' + employeeInput);
	                $("#expenses-revenue-row-data").load('../Work/GetFinancialExpenses');
	            } else {
	                alert(response.responseText);
	            }
	        },
	...
	function createTempLoadNbr() {
	    ...
	    $.get("../Work/getMaxDayLoadCount?date_Val=" + vDateString, function (data) {
	...
	function reloadIndex() {
	   // $('#index-company-stats').load('../Work/GetIndexStats');
	    $('#open-load-row').load('../Work/GetOpenLoadSummaryIndex');
	    $('#closed-load-row').load('../Work/GetClosedLoadSummaryIndex');
	    $("#openloadsEditList").load('../Work/GetLoadChangeList?ChangeAction=edit');
	    $("#fuel-purchase-row").load('../Work/GetFuelPurchases');
        $("#openloadsStatusList").load('../Work/GetLoadChangeList?ChangeAction=status');
	...
	function reloadNotesAlerts() {
	    $('#web-notes-rows').load('../Work/WebNotesIndex');
	    $('#web-alerts-rows').load('../Work/WebAlertsIndex');
	    $("#note-count-notification").load('../Work/WebNotesCountIndex');
	}
	...
	function reloadPayrolltbl() {
	    $("#payroll-row-data").load('../Work/GetPayrollSummaryIndex');
	}
