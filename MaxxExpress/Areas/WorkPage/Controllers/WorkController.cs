...
using MaxxExpress.Areas.WorkPage.Models.Tools;
using MaxxExpress.Areas.WorkPage.Models;
...
namespace MaxxExpress.Areas.WorkPage.Controllers
{
    ...
    public class WorkController : Controller
    {
        ...
        public string getHomepageWeekStats(string StartDate, string EndDate, string type)
        {
            using (cascadiaEntities db_data = new cascadiaEntities())
            {
                if(StartDate == null && EndDate == null) { // Return Last Weeks Data by Default
        ...
        public ActionResult CreateNote([FromBody] tbl_web_notes note)
        {
            ...
            {
                System.Net.Http.HttpRequestMessage NewRequest = new System.Net.Http.HttpRequestMessage();
                WorkViewModel addLoadVM = new WorkViewModel();
        ...
        public PartialViewResult CreateNoteIndex()
        {
            using (cascadiaEntities db_data = new cascadiaEntities())
            {
                WorkViewModel createNoteVM = new WorkViewModel();
                ...
                createNoteVM.vM_CreateNote_SendTo_List = staffList.Select(m => new WorkViewModel.KeyVal_Object { Id = m.ID.ToString(), Value = m.Value.ToString() });
        ...
        {
            WorkViewModel NoteVM = new WorkViewModel();
        ...
        public ActionResult Index()
        {
            ...
            ///
                ...
                List<WorkViewModel.KeyVal_Object> emptyList = new List<WorkViewModel.KeyVal_Object>();

                //Add Load Modal                 
                workVM.AddLoad_Weekof_List = emptyList;
                workVM.AddLoad_Driver_List = emptyList;
                workVM.AddLoad_Customer_List = emptyList;
                workVM.AddLoad_DayofWeek_List = emptyList;
                workVM.AddLoad_Route_List = emptyList;
                workVM.AddLoad_LoadofWeek_List = emptyList;
                workVM.AddLoad_Truck_List = emptyList;
                workVM.AddLoad_Trailer_List = emptyList;
                workVM.AddLoad_LTL_IND_List = emptyList;
                workVM.AddLoad_LoadFileName = null;
                workVM.AddLoad_Load_Confirmation_Upload = null;
                //End Add Load Modal

                //Edit Load Modal  
                workVM.EditLoad_Customer_List = emptyList;
                workVM.EditLoad_Route_List = emptyList;
                workVM.EditLoad_Driver_List = emptyList;
                workVM.EditLoad_Truck_List = emptyList;
                workVM.EditLoad_DayofWeek_List = emptyList;
                workVM.EditLoad_Trailer_List = emptyList;
                workVM.EditLoad_LTL_IND_List = emptyList;
                workVM.EditLoad_LoadofWeek_List = emptyList;
                workVM.EditLoad_Weekof_List = emptyList;
                workVM.EditLoad_Customer_ID = null;
                workVM.EditLoad_Customer_NM = null;
                workVM.EditLoad_Driver_Nbr = null;
                workVM.EditLoad_Truck_Nbr = null;
                workVM.EditLoad_Load_Date = null;
                workVM.EditLoad_Trailer_Nbr = null;
                workVM.EditLoad_Load_Confirmation_Upload = null;
                workVM.EditLoad_Weekof_Current = null;
                workVM.EditLoad_HasLoad_LoadConfirmation = false;
                workVM.EditLoad_HasDeliveryConfirmation = false;
                workVM.EditLoad_MulitpleStops = false;
                //End Edit Load Modal
        ...
        public PartialViewResult GetAddLoad()
        {
            using (cascadiaEntities db_data = new cascadiaEntities())
            {
                ...
                addLoadVM.AddLoad_Weekof_List = weekDistinct.Select(m => new WorkViewModel.KeyVal_Object { Id = m, Value = m });
                addLoadVM.AddLoad_Customer_List = CustomerList.Select(m => new WorkViewModel.KeyVal_Object { Id = m.ID.ToString(), Value = m.Value.ToString() });
                addLoadVM.AddLoad_DayofWeek_List = DayList.Select(m => new WorkViewModel.KeyVal_Object { Id = m.ID.ToString(), Value = m.Value.ToString() });
                addLoadVM.AddLoad_Route_List = RouteList.Select(m => new WorkViewModel.KeyVal_Object { Id = m.ID.ToString(), Value = m.Value.ToString() });
                addLoadVM.AddLoad_Driver_List = DriverList.Select(m => new WorkViewModel.KeyVal_Object { Id = m.ID.ToString(), Value = m.Value.ToString() });
                addLoadVM.AddLoad_Truck_List = TruckList.Select(m => new WorkViewModel.KeyVal_Object { Id = m.ID.ToString(), Value = m.Value.ToString() });
                addLoadVM.AddLoad_Trailer_List = TrailerList.Select(m => new WorkViewModel.KeyVal_Object { Id = m.ID.ToString(), Value = m.Value.ToString() });
        ...
        public PartialViewResult GetAddFuel()
        {
            using (cascadiaEntities db_data = new cascadiaEntities())
            {
                WorkViewModel addFuelVM = new WorkViewModel();
                ...
                var weekDistinct = Week_List.Cast<string>().Distinct().ToList();
                addFuelVM.AddFuel_DayofWeek_List = DayList.Select(m => new WorkViewModel.KeyVal_Object { Id = m.ID.ToString(), Value = m.Value.ToString() });
                addFuelVM.AddFuel_Driver_List = DriverList.Select(m => new WorkViewModel.KeyVal_Object { Id = m.ID.ToString(), Value = m.Value.ToString() });
                addFuelVM.AddFuel_Truck_List = TruckList.Select(m => new WorkViewModel.KeyVal_Object { Id = m.ID.ToString(), Value = m.Value.ToString() });
        ...
        public PartialViewResult GetLoadEditDetail(string LoadNbr)
        {
            using (cascadiaEntities db_data = new cascadiaEntities())
            {
                WorkViewModel editLoadVM = new WorkViewModel();
                ...
                editLoadVM.EditLoad_Customer_List = CustomerList.Select(m => new WorkViewModel.KeyVal_Object { Id = m.ID.ToString(), Value = m.Value.ToString() });
                editLoadVM.EditLoad_Driver_List = DriverList.Select(m => new WorkViewModel.KeyVal_Object { Id = m.ID.ToString(), Value = m.Value.ToString() });
                editLoadVM.EditLoad_Route_List = RouteList.Select(m => new WorkViewModel.KeyVal_Object { Id = m.ID.ToString(), Value = m.Value.ToString() });
                editLoadVM.EditLoad_Truck_List = TruckList.Select(m => new WorkViewModel.KeyVal_Object { Id = m.ID.ToString(), Value = m.Value.ToString() });
                editLoadVM.EditLoad_Trailer_List = TrailerList.Select(m => new WorkViewModel.KeyVal_Object { Id = m.ID.ToString(), Value = m.Value.ToString() });
                editLoadVM.EditLoad_Weekof_Current = weekText;
                editLoadVM.EditLoad_DayofWeek_List = DayList.Select(m => new WorkViewModel.KeyVal_Object { Id = m.ID.ToString(), Value = m.Value.ToString() });
                editLoadVM.vM_EditLoadData = db_data.vw_loads_detail_open.Single(a => a.Load_Number == LoadNbr);
                var weekDistinct = Week_List.Cast<string>().Distinct().ToList();
                editLoadVM.EditLoad_Weekof_List = weekDistinct.Select(m => new WorkViewModel.KeyVal_Object { Id = m, Value = m });
        ...
        public ActionResult GetLoadChangeList(string ChangeAction)
        {
            ...
            {
                ViewData["OpenLoadsStatusList"] = GetOpenLoadsSummary();
                return PartialView("_LoadStatusList", workVM);
            }
        ...
        {
            WorkViewModel financialsVM = new WorkViewModel();
        ...
        public PartialViewResult GetExpenseDetail(string exID)
        {
            using (cascadiaEntities db_data = new cascadiaEntities())
            {
                WorkViewModel expenseVM = new WorkViewModel();
        ...
        {
            WorkViewModel fuelVM = new WorkViewModel();
        ...
        {
            WorkViewModel expensesVM = new WorkViewModel();
        ...
        {
            WorkViewModel productionVM = new WorkViewModel();
        ...
        public void  RunPayroll()
        {
            using (cascadiaEntities db_data = new cascadiaEntities())
            {
                WorkViewModel payrollVM = new WorkViewModel();
        ...
        public PartialViewResult GetPayrollAdjustmentDetail()
        {
            using (cascadiaEntities db_data = new cascadiaEntities())
            {
                WorkViewModel payrollAdjVM = new WorkViewModel();
        ...
        public ActionResult admin()
        {
            ...
            if (Session.SessionID != null)
            {
                using (cascadiaEntities db_data = new cascadiaEntities())
                {
                    WorkViewModel adminVM = new WorkViewModel();
